...
project_src_dir='./src/agilex.persistence.openrasta'
build_mode='Release'
...
# build project
$msbuild $project_src_dir/agilex.persistence.openrasta.csproj /property:Configuration=$build_mode > $build_log
...
cp $project_output_dir/agilex.persistence.openrasta.dll $build_dir/lib/net40

# package
$nuget pack $package_spec_file -OutputDirectory $package_output_dir

# push to gallery (requires api key is set on command line)
$nuget push $package_output_dir/agilex.persistence.openrasta.$newversion.nupkg